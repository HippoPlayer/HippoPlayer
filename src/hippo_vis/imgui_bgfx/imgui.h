...
void imguiBeginFrame(uint16_t _width, uint16_t _height, bgfx::ViewId _view = 255);
void imguiEndFrame();
void imguiRenderDraws(ImDrawData* _drawData, int view, int width, int height);
