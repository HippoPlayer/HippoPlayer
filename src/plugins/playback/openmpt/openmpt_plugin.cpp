...
/*
	static const HUIntegerRangeValue s_interpolation_filter_ranges[] = {
	...
	static HUWidget settings_template[] = {
		HippoIntValue(ID_MASTER_GAIN, "Master Gain",
				"The related value represents a relative gain in decibel. The default value is 0", 0),
		HippoIntValue_Range(ID_STEREO_SEPARATION, "Stereo Separation",
				"The related value represents the stereo separation generated by the libopenmpt mixer in percent. The default value is 100 and supported range is 0 - 200",
				100, 0, 200),
		HippoIntValue_Range(ID_VOLUME_RAMPING, "Volume Ramping Strength",
				"The related value represents the interpolation filter length used by the libopenmpt mixer.",
				-1, -1, 10),
		HippoIntValue_DescRange(INTERPOLATION_RANGE, "Interpolation Filter",
				"The related value represents the interpolation filter length used by the libopenmpt mixer.", 0,
				s_interpolation_filter_ranges),
		HippoFloatValue(ID_TEMPO_FACTOR, "Tempo Factor",
				"Set the tempo factor. Default value is 1.0", 1.0),
		HippoFloatValue(ID_PITCH_FACTOR, "Tempo Factor",
				"Set the tempo factor. Default value is 1.0", 1.0),
	};

	static const HUStringRangeValue s_amiga_filter_values[] = {
		{ "Default filter", "auto" },
	...
	static HUWidget global_settings[] = {
		HippoBoolValue(ID_USE_AMIGA_RESAMPLER_AMIGA_MODS, "Use Amiga Resampler for Amiga modules",
				"Set to enable the Amiga resampler for Amiga modules. This emulates the sound characteristics of the Paula chip and overrides the selected interpolation filter. Non-Amiga module formats are not affected by this setting.",
				false),
		HippoStringValue_DescRange(ID_AMIGA_RESAMPLER_FILTER, "Filter type for Amiga Resampler",
				"Filter type for Amiga filter if enabled", "auto",
				s_amiga_filter_values),
	};
*/
