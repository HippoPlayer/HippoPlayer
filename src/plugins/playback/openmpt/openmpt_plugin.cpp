...
static HUWidget s_settings_template[] = {
    ...
    HippoIntValue_Range(ID_VOLUME_RAMPING, "Volume Ramping Strength",
                        ...
                        -1, -1, 10),
    HippoIntValue_DescRange(
        INTERPOLATION_RANGE, "Interpolation Filter",
        "The related value represents the interpolation filter length used by the libopenmpt mixer.", 0,
        s_interpolation_filter_ranges),
    HippoFloatValue(ID_TEMPO_FACTOR, "Tempo Factor", "Set the tempo factor. Default value is 1.0", 1.0),
    HippoFloatValue(ID_PITCH_FACTOR, "Tempo Factor", "Set the tempo factor. Default value is 1.0", 1.0),
};
...
static HUWidget s_global_settings[] = {
...
static void openmpt_static_init(struct HippoLogAPI* log) {
    g_hp_log = log;
}
...
static int openmpt_register_settings(const struct HippoSettingsAPI* api) {
    //HippoSettings_register_filetype_settings(api, s_settings_template);
    //HippoSettings_register_global_settings(api, s_global_settings);
