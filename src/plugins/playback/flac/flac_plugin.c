...
static IdMap s_ids[] = {
    ...
    {"COMMENT", HippoMetadata_MessageTag}, {"GENRE", HippoMetadata_GenreTag}, {"DATE", HippoMetadata_DateTag},
};
...
static void flac_metadata_callback(void* userdata, drflac_metadata* metadata) {
    ...
    drflac_init_vorbis_comment_iterator(&iter, metadata->data.vorbis_comment.commentCount,
