...
pub const MA_VERSION_REVISION: u32 = 16;
...
impl ma_channel_converter {
    ...
    pub fn new_bitfield_1(
        ...
        __bindgen_bitfield_unit.set(0usize, 1u8, {
            let isPassthrough: u32 = unsafe { ::std::mem::transmute(isPassthrough) };
            isPassthrough as u64
        });
        __bindgen_bitfield_unit.set(1usize, 1u8, {
            let isSimpleShuffle: u32 = unsafe { ::std::mem::transmute(isSimpleShuffle) };
            isSimpleShuffle as u64
        });
        __bindgen_bitfield_unit.set(2usize, 1u8, {
            let isSimpleMonoExpansion: u32 =
                unsafe { ::std::mem::transmute(isSimpleMonoExpansion) };
            isSimpleMonoExpansion as u64
        });
        __bindgen_bitfield_unit.set(3usize, 1u8, {
            let isStereoToMono: u32 = unsafe { ::std::mem::transmute(isStereoToMono) };
    ...
    pub fn new_bitfield_1(
        ...
        __bindgen_bitfield_unit.set(0usize, 1u8, {
            let hasPreFormatConversion: u32 =
                unsafe { ::std::mem::transmute(hasPreFormatConversion) };
            hasPreFormatConversion as u64
        });
        __bindgen_bitfield_unit.set(1usize, 1u8, {
            let hasPostFormatConversion: u32 =
                unsafe { ::std::mem::transmute(hasPostFormatConversion) };
            hasPostFormatConversion as u64
        });
        __bindgen_bitfield_unit.set(2usize, 1u8, {
            let hasChannelConverter: u32 = unsafe { ::std::mem::transmute(hasChannelConverter) };
            hasChannelConverter as u64
        });
        __bindgen_bitfield_unit.set(3usize, 1u8, {
            let hasResampler: u32 = unsafe { ::std::mem::transmute(hasResampler) };
            hasResampler as u64
        });
...
impl ma_rb {
    ...
    pub fn new_bitfield_1(
        ...
        let mut __bindgen_bitfield_unit: __BindgenBitfieldUnit<[u8; 1usize], u8> =
            Default::default();
        __bindgen_bitfield_unit.set(0usize, 1u8, {
            let ownsBuffer: u32 = unsafe { ::std::mem::transmute(ownsBuffer) };
            ownsBuffer as u64
        });
        __bindgen_bitfield_unit.set(1usize, 1u8, {
            let clearOnWriteAcquire: u32 = unsafe { ::std::mem::transmute(clearOnWriteAcquire) };
...
impl ::std::fmt::Debug for ma_device_info {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        write ! ( f , "ma_device_info {{ id: {:?}, name: [{}], formatCount: {:?}, formats: {:?}, minChannels: {:?}, maxChannels: {:?}, minSampleRate: {:?}, maxSampleRate: {:?}, _private: {:?} }}" , self . id , self . name . iter ( ) . enumerate ( ) . map ( | ( i , v ) | format ! ( "{}{:?}" , if i > 0 { ", " } else { "" } , v ) ) . collect :: < String > ( ) , self . formatCount , self . formats , self . minChannels , self . maxChannels , self . minSampleRate , self . maxSampleRate , self . _private )
    }
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub struct ma_context {
    ...
    pub onDeviceIDEqual: ::std::option::Option<
        unsafe extern "C" fn(
            pContext: *mut ma_context,
...
pub struct ma_context__bindgen_ty_1__bindgen_ty_2 {
    ...
    pub pApplicationName: *mut ::std::os::raw::c_char,
    pub pServerName: *mut ::std::os::raw::c_char,
    pub tryAutoSpawn: ma_bool32,
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
    ...
    pub fn new_bitfield_1(
        ...
        __bindgen_bitfield_unit.set(0usize, 1u8, {
            let isBackendAsynchronous: u32 =
                unsafe { ::std::mem::transmute(isBackendAsynchronous) };
...
impl ::std::fmt::Debug for ma_device__bindgen_ty_2 {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        write ! ( f , "ma_device__bindgen_ty_2 {{ id: {:?}, name: [{}], shareMode: {:?}, usingDefaultFormat : {:?}, usingDefaultChannels : {:?}, usingDefaultChannelMap : {:?}, format: {:?}, channels: {:?}, channelMap: [{}], internalFormat: {:?}, internalChannels: {:?}, internalSampleRate: {:?}, internalChannelMap: [{}], internalPeriodSizeInFrames: {:?}, internalPeriods: {:?}, converter: {:?} }}" , self . id , self . name . iter ( ) . enumerate ( ) . map ( | ( i , v ) | format ! ( "{}{:?}" , if i > 0 { ", " } else { "" } , v ) ) . collect :: < String > ( ) , self . shareMode , self . usingDefaultFormat ( ) , self . usingDefaultChannels ( ) , self . usingDefaultChannelMap ( ) , self . format , self . channels , self . channelMap . iter ( ) . enumerate ( ) . map ( | ( i , v ) | format ! ( "{}{:?}" , if i > 0 { ", " } else { "" } , v ) ) . collect :: < String > ( ) , self . internalFormat , self . internalChannels , self . internalSampleRate , self . internalChannelMap . iter ( ) . enumerate ( ) . map ( | ( i , v ) | format ! ( "{}{:?}" , if i > 0 { ", " } else { "" } , v ) ) . collect :: < String > ( ) , self . internalPeriodSizeInFrames , self . internalPeriods , self . converter )
    }
}
impl ma_device__bindgen_ty_2 {
    ...
    pub fn new_bitfield_1(
        ...
        let mut __bindgen_bitfield_unit: __BindgenBitfieldUnit<[u8; 1usize], u8> =
            Default::default();
        __bindgen_bitfield_unit.set(0usize, 1u8, {
            let usingDefaultFormat: u32 = unsafe { ::std::mem::transmute(usingDefaultFormat) };
            usingDefaultFormat as u64
        });
        __bindgen_bitfield_unit.set(1usize, 1u8, {
            let usingDefaultChannels: u32 = unsafe { ::std::mem::transmute(usingDefaultChannels) };
            usingDefaultChannels as u64
        });
        __bindgen_bitfield_unit.set(2usize, 1u8, {
            let usingDefaultChannelMap: u32 =
                unsafe { ::std::mem::transmute(usingDefaultChannelMap) };
...
impl ma_device__bindgen_ty_4__bindgen_ty_1 {
    ...
    pub fn new_bitfield_1(
        ...
        let mut __bindgen_bitfield_unit: __BindgenBitfieldUnit<[u8; 1usize], u8> =
            Default::default();
        __bindgen_bitfield_unit.set(0usize, 1u8, {
            let isUsingMMapPlayback: u32 = unsafe { ::std::mem::transmute(isUsingMMapPlayback) };
            isUsingMMapPlayback as u64
        });
        __bindgen_bitfield_unit.set(1usize, 1u8, {
            let isUsingMMapCapture: u32 = unsafe { ::std::mem::transmute(isUsingMMapCapture) };
...
pub struct ma_device__bindgen_ty_4__bindgen_ty_2 {
    ...
    pub pMappedBufferCapture: *const ::std::os::raw::c_void,
...
impl ma_device__bindgen_ty_4__bindgen_ty_2 {
    ...
    pub fn new_bitfield_1(breakFromMainLoop: ma_bool32) -> __BindgenBitfieldUnit<[u8; 1usize], u8> {
        let mut __bindgen_bitfield_unit: __BindgenBitfieldUnit<[u8; 1usize], u8> =
            Default::default();
        __bindgen_bitfield_unit.set(0usize, 1u8, {
            let breakFromMainLoop: u32 = unsafe { ::std::mem::transmute(breakFromMainLoop) };
    ...
    pub fn new_bitfield_1(
        ...
        __bindgen_bitfield_unit.set(0usize, 1u8, {
            let usingDefaultSampleRate: u32 =
                unsafe { ::std::mem::transmute(usingDefaultSampleRate) };
            usingDefaultSampleRate as u64
        });
        __bindgen_bitfield_unit.set(1usize, 1u8, {
            let usingDefaultBufferSize: u32 =
                unsafe { ::std::mem::transmute(usingDefaultBufferSize) };
            usingDefaultBufferSize as u64
        });
        __bindgen_bitfield_unit.set(2usize, 1u8, {
            let usingDefaultPeriods: u32 = unsafe { ::std::mem::transmute(usingDefaultPeriods) };
            usingDefaultPeriods as u64
        });
        __bindgen_bitfield_unit.set(3usize, 1u8, {
            let isOwnerOfContext: u32 = unsafe { ::std::mem::transmute(isOwnerOfContext) };
            isOwnerOfContext as u64
        });
        __bindgen_bitfield_unit.set(4usize, 1u8, {
            let noPreZeroedOutputBuffer: u32 =
                unsafe { ::std::mem::transmute(noPreZeroedOutputBuffer) };
            noPreZeroedOutputBuffer as u64
        });
        __bindgen_bitfield_unit.set(5usize, 1u8, {
            let noClip: u32 = unsafe { ::std::mem::transmute(noClip) };
            noClip as u64
        });
        __bindgen_bitfield_unit
    }
