...
pub struct HippoMessageAPI {
    ...
    pub priv_data: *mut HippoEventAPI,
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub struct HippoPlaybackPlugin {
    ...
    pub configure: ::std::option::Option<
        unsafe extern "C" fn(user_data: *mut ::std::os::raw::c_void, ui_funcs: *mut PU)
            -> ::std::os::raw::c_int,
    >,
...
pub struct HippoViewPlugin {
    ...
    pub version: *const ::std::os::raw::c_char,
    pub create: ::std::option::Option<
        unsafe extern "C" fn(services: *mut HippoServiceAPI, ui_funcs: *mut PU, window: PUWidget)
